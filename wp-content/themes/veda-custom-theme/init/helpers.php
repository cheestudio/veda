...
function custom_login_screen() { ?>
  <style type="text/css">
    body {
      background: linear-gradient(to bottom, #b3e1e8, 90%, #1796a4) !important;
    }
    #login h1 a {
...
/* Add TinyMCE buttons for Posts
========================================================= */
add_filter('mce_buttons_2', 'add_tinymce_buttons_posts');
function add_tinymce_buttons_posts( $buttons ) { 
  $buttons[] = 'superscript';
  return $buttons;
}
