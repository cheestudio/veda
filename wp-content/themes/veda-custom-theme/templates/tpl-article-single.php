<?php
/**
 * Sub-level article template.
 *
 * This template is included in the "single-article" template.
 *
 * It is included if this is a "sub level" article.
 */
?>

<?php $category = wp_get_post_terms( $post->ID, 'article_category' ); ?>
    ...
    <div class="container">
      <div class="article-main-single--content">
        ...
        <div class="inner">
          ...
          <div class="article-fulltext hide">
          ...
          foreach ( $rows as $key => $value ) :
            if ( $value ) :
              switch ( $key ) :
                ...
                case 'read_choice' :
                  echo "<a 
                     class = 'toggle readmore show'
                     id    = 'article-readmore-toggle'
                     href = '#article-top'
                     title = 'Click to Read the Full Article'
                     >Read Full Article</a>
                     <a class = 'toggle hidemore hide'
                     id    = 'article-hidemore-toggle'
                     href = '#article-top'
                     title = 'Click to Hide the Full Article'
                       >Hide Full Article</a>";
                  break;
