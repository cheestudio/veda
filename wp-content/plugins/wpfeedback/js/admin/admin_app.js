            ...
            var new_task_screenshot_obj = jQuery.extend({}, task_screenshot);
                ...
                jQuery.ajax({
                    ...
                    success: function(data){
                        jQuery('.wpf_loader_'+id).hide();
                        console.log('Upload successfully');
                        var comment_html = '<li class="wpf_author"><level class="task-author">'+current_user_name +' '+wpf_just_now+'</level><div class="meassage_area_main"><a href="'+data+'" target="_blank"><img src="'+data+'" title="WPF Screenshot" alt="WPF Screenshot"/></a></div></li>';
                        jQuery('#task_comments_'+id).append(comment_html);
                        jQuery('#task_comments_'+id).animate({scrollTop: jQuery('#task_comments_'+id).prop("scrollHeight")}, 2000);
                    }
                });
...
jQuery(document).ready(function(){ 
    if(disable_for_admin == 0){
        ...
        jQuery( function() {
        jQuery( ".wpf_launch_buttons" ).draggable({ containment: "#wpwrap" });
    });
    }
        ...
        success : function(data){       
            ...
            if(data!=0){
                ...
                if(new_task['task_type']=='general'){
                    ...
                    jQuery('#wpf_thispage_container').prepend('<li class="current_page_general_task open" data-taskid="'+id+'" data-postid="'+tasks_on_page[id]+'"><div class="wpf_task_number">'+id+'</div><div class="wpf_task_sum"><level class="task-author">'+current_user_name+' '+wpf_just_now+' <span>'+wpf_general_tag+'</span></level><div class="current_page_task_list">'+task_comment+'</div></div></li>');
                }else{
                    jQuery('#wpf_thispage_container').prepend('<li class="current_page_task open" data-taskid="'+id+'"><div class="wpf_task_number">'+id+'</div><div class="wpf_task_sum"><level class="task-author">'+current_user_name+' '+wpf_just_now+' </level><div class="current_page_task_list">'+task_comment+'</div></div></li>');
                }
    ...
    jQuery.ajax({
        ...
        success: function(data){
            ...
            jQuery.each(k,function (index, value) {
                ...
                jQuery( function() {
                    jQuery( "#bubble-"+onload_wpfb_tasks[value].task_comment_id).draggable();
                });
            ...
            jQuery(document).find("#wpf_frontend_container").on("click","li.current_page_task",function(e) {
                 var task_url = jQuery(this).attr('data-task_url');
...
function generate_wpfb_task_html(wpfb_task_id,wpfb_metas){
    ...
    if(wpfb_metas.task_type=='general'){
        var wpfb_current_page_task_list_html = '<li class="current_page_general_task '+wpfb_metas.task_status+ " " + wpfb_metas.task_priority+'" data-taskid="'+comment_count+'" data-postid="'+wpfb_task_id+'"><div class="wpf_task_number">'+bubble_label+'</div><div class="wpf_task_sum"><level class="task-author">'+wpfb_metas.task_config_author_name+' '+wpfb_metas.task_time+' <span>'+wpf_general_tag+'</span></level><div class="current_page_task_list">'+wpfb_metas.task_title+'</div></div></li>';
        ...
        for (var key in wpfb_metas.comments) {
            ...
            if(wpfb_metas.comments[key].comment_type==0){
                ...
                wpfb_messages_html += '<li class="'+task_author+'"><level class="task-author">'+wpfb_metas.comments[key].author+' '+wpfb_metas.comments[key].time+'</level><div class="meassage_area_main"><iframe width="100%" height="120" src="https://www.youtube.com/embed/'+wpfb_metas.comments[key].message+'"></iframe></div></li>';
            }
...
function openWPFTab_admin(wpfTab) {
    if(wpfTab == 'wpf_allpages'){
        ...
        jQuery('.wpf_sidebar_content').find('#wpf_frontend').hide(); 
        ...
        jQuery('.wpf_sidebar_content').find('#wpf_frontend').show(); 
        jQuery('.wpf_sidebar_content').find('#wpf_thispage').hide(); 
        jQuery('button.wpf_tab_sidebar').removeClass('wpf_active');
        jQuery('button.wpf_tab_sidebar.'+wpfTab).addClass('wpf_active');
        ...
        success: function(data){
            ...
            jQuery.each(k,function (index, value) {
                ...
                if(onload_wpfb_tasks[value].task_type=='general'){
                    ...
                    wpfb_all_page_task_list_html += '<li class="current_page_task ' +onload_wpfb_tasks[value].task_status+ " " + onload_wpfb_tasks[value].task_priority+'" data-taskid="'+onload_wpfb_tasks[value].task_comment_id+'" data-postid="'+value+'" data-task_url="'+onload_wpfb_tasks[value].task_page_url+saperater+'wpf_general_taskid='+value+'"><div class="wpf_task_number">'+bubble_label+'</div><div class="wpf_task_sum"><level class="task-author">'+onload_wpfb_tasks[value].task_config_author_name+' '+onload_wpfb_tasks[value].task_time+' '+general_tag+'</level><div class="wpf_task_pagename">'+onload_wpfb_tasks[value].task_page_title+'</div><div class="current_page_task_list">'+onload_wpfb_tasks[value].task_title+'</div></div></li>';
                }
                else{
                    wpfb_all_page_task_list_html += '<li class="current_page_task ' +onload_wpfb_tasks[value].task_status+ " " + onload_wpfb_tasks[value].task_priority+'" data-taskid="'+onload_wpfb_tasks[value].task_comment_id+'" data-task_url="'+onload_wpfb_tasks[value].task_page_url+saperater+'wpf_taskid='+onload_wpfb_tasks[value].task_comment_id+'"><div class="wpf_task_number">'+bubble_label+'</div><div class="wpf_task_sum"><level class="task-author">'+onload_wpfb_tasks[value].task_config_author_name+' '+onload_wpfb_tasks[value].task_time+' '+general_tag+'</level><div class="wpf_task_pagename">'+onload_wpfb_tasks[value].task_page_title+'</div><div class="current_page_task_list">'+onload_wpfb_tasks[value].task_title+'</div></div></li>';
                }
        ...
        success: function(data){
            ...
            jQuery.each(k,function (index, value) {
                ...
                if(onload_wpfb_tasks[value].task_type=='general'){
                    ...
                    wpfb_all_page_task_list_html += '<li class="current_page_task ' +onload_wpfb_tasks[value].task_status+ " " + onload_wpfb_tasks[value].task_priority+'" data-taskid="'+onload_wpfb_tasks[value].task_comment_id+'" data-task_url="'+onload_wpfb_tasks[value].task_page_url+'?wpf_taskid='+onload_wpfb_tasks[value].task_comment_id+'"><div class="wpf_task_number">'+bubble_label+'</div><div class="wpf_task_sum"><level class="task-author">'+onload_wpfb_tasks[value].task_config_author_name+' '+onload_wpfb_tasks[value].task_time+' '+general_tag+'</level><div class="wpf_task_pagename">'+onload_wpfb_tasks[value].task_page_title+'</div><div class="current_page_task_list">'+onload_wpfb_tasks[value].task_title+'</div></div></li>';
                }

                comment_count_initial--;
            });

            jQuery("#wpf_frontend_container").html(wpfb_all_page_task_list_html);
        }
    });
}
