...
jQuery(document).ready(function(){
    ...
    //console.log(wpf_tab_permission.auto_screenshot);
});
    ...
    if(wpfb_metas.task_type=='general'){
        ...
        for (var key in wpfb_metas.comments) {
            ...
            if(wpfb_metas.comments[key].comment_type==0){
                ...
                wpfb_messages_html += '<li class="'+task_author+'"><level class="task-author">'+wpfb_metas.comments[key].author+' '+wpfb_metas.comments[key].time+'</level><div class="meassage_area_main"><a href="'+wpfb_metas.comments[key].message+'" target="_blank"><img src="'+wpfb_metas.comments[key].message+'" class="wpf_task_uploaded_image" title="WPF Screenshot" alt="WPF Screenshot"/></a></div></li>';
            }
